 ...
 * [BikeShareFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [BikeShareFragment.newInstance] factory method to
...
class BikeShareFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment BikeShareFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BikeShareFragment().apply {
